...
export default function SettingsScreen() {
  ...
  const handleDateChange = (date: Date) => {
    console.log("[Settings] iOS birthday date changed:", formatDateApi(date));
    setPickerDate(date);
  };
    ...
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      {Platform.OS !== "ios" && showBirthdayPicker && (
        <DatePicker
          value={pickerDate}
          onChange={(d) => {
            console.log("[Settings] Android/web birthday date selected:", formatDateApi(d));
            setPickerDate(d);
            saveBirthday(d);
            setShowBirthdayPicker(false);
          }}
      ...
      {/* Anniversary Modal — iOS: bottom sheet */}
      {Platform.OS === "ios" && (
        <Modal
          ...
          <View style={{ flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.3)" }}>
            ...
            >
              ...
              <DatePicker
                ...
                onChange={(d) => {
                  console.log("[Settings] Anniversary date changed:", formatDateApi(d));
                  setNewAnniversaryDate(d);
                }}
                display="spinner"
                locale="de-DE"
                style={{ width: "100%" }}
          ...
          <View style={{ flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.3)" }}>
            ...
            >
              ...
              <DatePicker
                value={newAnniversaryDate}
                onChange={(d) => {
                  console.log("[Settings] Anniversary date changed (Android/web):", formatDateApi(d));
                  setNewAnniversaryDate(d);
                }}
                display="default"
              />
              ...
              <View style={{ flexDirection: "row", gap: 10 }}>
                <AnimatedPressable
                  onPress={handleAnniversaryModalCancel}
                  style={{
                    flex: 1,
                    height: 48,
                    borderRadius: 12,
