...
export const BACKEND_URL = process.env.EXPO_PUBLIC_BACKEND_URL || Constants.expoConfig?.extra?.backendUrl || "https://7se5q84f6y2fxh3m28gyshca4wub75wv.app.specular.dev";
