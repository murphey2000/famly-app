...
const API_URL = process.env.EXPO_PUBLIC_BACKEND_URL || (Constants.expoConfig?.extra?.backendUrl as string) || "https://7se5q84f6y2fxh3m28gyshca4wub75wv.app.specular.dev";
